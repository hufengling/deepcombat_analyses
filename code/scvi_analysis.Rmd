...
write.csv(adni_cov, "./data/for_paper/for_figures/adni_dem.csv", 
          row.names = F)
...
write.csv(methods_lr, "./data/for_paper/for_figures/methods_lr.csv", 
          row.names = F)
...
lambdas_lr$Method <- lambda_names_table
...
write.csv(lambdas_lr, "./data/for_paper/for_figures/lambdas_lr.csv", 
          row.names = F)
...
write.csv(methods_manova, "./data/for_paper/for_figures/methods_manova.csv", 
          row.names = F)
...
lambdas_manova <- lambdas_manova[lambdas_range, c(1, 6:9)] %>% 
  mutate(across(where(is.numeric), round, digits = 2)) %>% 
  rename(Method = dataset)
lambdas_manova$Method <- lambda_names_table
lambdas_manova[, -1] <- lambdas_manova[, -1] * -1
write.csv(lambdas_manova, "./data/for_paper/for_figures/lambdas_manova.csv", 
          row.names = F)
...
write.csv(methods_ad, "./data/for_paper/for_figures/methods_ad.csv", 
          row.names = F)
...
lambdas_ad <- lambdas_ad[lambdas_range, c(1, 4:5)] %>% 
  ...
  mutate(`Log 10 p-value` = `Log 10 p-value` * -1) %>% 
  mutate(`Log 10 p-value` = paste0(`Log 10 p-value`, " (", SD, ")"))
lambdas_ad$Method <- lambda_names_table
lambdas_ad <- lambdas_ad[, -3]
write.csv(lambdas_ad, "./data/for_paper/for_figures/lambdas_ad.csv", 
          row.names = F)
