...
#                                   outcome = "DIAGNOSIS",
#                                   k_fold = 10, repeats = 5, verbose = T)
# write.csv(manufac_results, "./data/for_paper/ml/manufac.csv")
# write.csv(age_results, "./data/for_paper/ml/age.csv")
# write.csv(sex_results, "./data/for_paper/ml/sex.csv")
# write.csv(diagnosis_results, "./data/for_paper/ml/diagnosis.csv")
```

## Read ML csvs
```{r}
ml_results <- lapply(list.files("./data/for_paper/ml", full.names = TRUE), function(path) {
  df <- path %>% 
    read.csv() %>% 
    as.data.frame()
...
manufac_lambdas <- ggplot(manufac_lambdas_df, aes(x = algorithm_releveled, y = ROC, 
  ...
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()); manufac_lambdas
...
sex_methods <- ggplot(sex_methods_df, aes(x = algorithm_releveled, y = ROC, 
  ...
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()); sex_methods
...
sex_lambdas <- ggplot(sex_lambdas_df, aes(x = algorithm_releveled, y = ROC, 
  ...
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()); sex_lambdas
...
diag_methods <- ggplot(diagnosis_methods_df, aes(x = algorithm_releveled, y = Accuracy, 
  ...
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()); diag_methods
...
diag_lambdas <- ggplot(diagnosis_lambdas_df, aes(x = algorithm_releveled, y = Accuracy, 
  ...
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()); diag_lambdas
...
age_methods <- ggplot(age_methods_df, aes(x = algorithm_releveled, y = Rsquared, 
  ...
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()); age_methods
...
age_lambdas <- ggplot(age_lambdas_df, aes(x = algorithm_releveled, y = Rsquared, 
  ...
  theme_minimal() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank()); age_lambdas
...
ml_combined_methods <- ggarrange(plotlist = list(manufac_methods, sex_methods, 
                                                 diag_methods, age_methods), common.legend = TRUE, 
                                 legend = "right",
                                 ncol = 2, nrow = 2, labels = "AUTO")

ml_combined_lambdas <- ggarrange(plotlist = list(manufac_lambdas, sex_lambdas, 
                                                 diag_lambdas, age_lambdas), common.legend = TRUE, 
                                 legend = "right",
                                 ncol = 2, nrow = 2, labels = "AUTO")
